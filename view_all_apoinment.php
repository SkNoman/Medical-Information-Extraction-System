...
<body>
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
						<a class="nav-link active" href="view_doctor_appointment.php">Todays Appointments</a>
					</li>
					<li class="nav-item">
						<a class="nav-link active" href="#">My all Appointments</a>
					</li>
                    <li class="nav-item">
	...
	<?php 
		...
		$sql = "SELECT * FROM `appoinment` WHERE dId='$sid'";
