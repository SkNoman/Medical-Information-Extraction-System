			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <li class="nav-item">
                        ...
                        <?php
						 ...
						 $query1 = mysqli_query($connection,"select dName from doctordata where dId='$sid'");
			...
			<div class="col-sm">
				<div class="card" style="width: 30rem;">
					...
					<div class="card-body">
						...
						<a href="view_all_apoinment.php" class="btn btn-info">All Appointments</a><br><br>
						<a href="view_doctor_appointment.php" class="btn btn-success">Todays Appointments</a><br><br>
						<a href="#" class="btn btn-primary">Check Appointment</a><br><br>
						<a href="doc_time.php" class="btn btn-dark">Edit My Schedule</a>
						<a href="about_us.php" class="btn btn-success">Contact With Admin</a>
					</div>
				</div>
			</div>
			<div class="col-sm">
				<div class="card" style="width: 25rem;">
					<img src="images/doctor_login.jpg" class="card-img-top" alt="online doctor">
					<div class="card-body">
						<h5 class="card-title"><?php echo  $data['dName']; ?></h5>
						<p class="card-text">He is can solve critical issues of patiests.<br> If You can contact with him
							online.</p>
