...
<body>
  ...
  <center><img src="images/d_login.png" alt="logo" width="200" height="200"></center>
  <br>
				...
				<div class="card" style="width: 30rem; background-color: #11C8EF;">
					...
					<div class="card-body">
						<form method="POST" action="login_connection.php">
							<left>
								...
								<div class="mb-3">
									...
									<div id="passowrd_help" class="form-text">We'll never share your password with anyone else.</div>
								</div>
						...
						<?php 
           					...
           					$_SESSION['tb']= "doctordata";
          					$_SESSION['location']="location:doctor_home.php";
            				$_SESSION['id']="dId";
            				$_SESSION['pass']="dPassword";
							$_SESSION['else']= "location:login_doctor.php";
							$_SESSION['wrong']= 0;
   						?>	
