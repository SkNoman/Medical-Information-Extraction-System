		...
		<div class="row">
			<div class="col-sm">
				<div class="card" style="width: 30rem;">
					...
					<div class="card-body">
						...
						<a href="ud.php" class="btn btn-info">My Documents</a>
					
						<a href="ud.php" class="btn btn-primary">My Follow Up</a><br><br>
						<a href="my_appoinments.php" class="btn btn-dark">My Appointment</a>
			...
			<div class="col-sm">
				<div class="card" style="width: 26rem;">
					<img src="images/person1.png" class="card-img-top" alt="online doctor">
					<div class="card-body">
						...
						echo  $data['pLastName'];
	                    ?></a></h5>
						<p class="card-text">23 Years Old.
