...
<div class="text">
		<b><h1>Welcome to MIES</h1></b><br><br>
		<h3>Have an Access to a Health Professional at any time.</h3>
		<b><h3>Personal Care for your Healthy Living.</h3></b><br><br>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-info">
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				...
				<form class="d-flex">
					<input class="form-control me-2" type="search" placeholder="Under Development" aria-label="Search">
		...
		<div class="row">
			<div class="col-sm">
				<div class="card" style="width: 30rem;">
					...
					<div class="card-body">
						...
						<a href="#" class="btn btn-info">Call: +8801718228277</a><br><br>
						<a href="about_us.php" class="btn btn-primary">More About Us</a><br><br>
						<a href="ud.php" class="btn btn-dark">Track Your Health</a>
						<a href="login_patient.php" class="btn btn-success">Make an Appointment</a>
					</div>
				</div>
			</div>
			<div class="col-sm">
				<div class="card" style="width: 25rem;">
					<img src="images/staff-1.jpg" class="card-img-top" alt="online doctor">
					<div class="card-body">
