	...
	<div class="row">
		<div class="col-sm">
			<div class="card" style="width: 25rem;">
				...
				<div class="card-body">
					<h5 class="card-title">Tunna</h5>
					<a href="#" class="btn btn-info">Her Appointments</a>
					<a href="#" class="btn btn-success">View Her Reports</a><br><br>
					<a href="#" class="btn btn-danger">Delete Patient Info</a><br><br>
        ...
        <?php
				if(isset($_POST['search'])){
					...
					if($row==1){
                        $sql2 = "SELECT * FROM appoinment WHERE pId='$sid'";
                        $qr2= mysqli_query($connection,$sql2);
                        $row2 = mysqli_num_rows($qr2);

                        if($row2>0){
                            while($data2=mysqli_fetch_array($qr2)){
                                ?>
                                    <div class="card-body"><!-- main form-->
							        <div class="card-body"><!-- main form-->
							    	<ul class="list-group">
									<li class="list-group-item disabled">Patient Id:  <?php echo $data2['pId']; ?></li>
									<li class="list-group-item">Doctor Id <?php echo $data2['dId']; ?></li>
									<li class="list-group-item">Date: <?php echo $data2['aDate']; ?></li>
									<li class="list-group-item">Time : <?php echo $data2['aTime']; ?></li>
									<li class="list-group-item">Appoinment Id: <?php echo $data2['aId']; ?></li>
