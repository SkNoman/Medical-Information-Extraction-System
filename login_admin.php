...
<body>
  ...
  <center><img src="images/a_login.png" alt="logo" width="200" height="200"></center>
  <br>
				...
				<div class="card" style="width: 30rem; background-color: #11C8EF;">
					...
					<div class="card-body">
						...
						<?php
  							...
  							$_SESSION['tb']= "admindb";
            				$_SESSION['location']="location:admin_home.php";
            				$_SESSION['id']="aId";
            				$_SESSION['pass']="aPassword";
							$_SESSION['else']= "location:login_admin.php";
  				 		?>
