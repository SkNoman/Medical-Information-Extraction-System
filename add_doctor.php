...
<body>
  ...
  <center><img src="images/add_doctor.png" alt="logo" width="200" height="200"></center>
  <br>
  ...
  <?php
                        if ( isset($_POST['submit'])){
                            ...
                            $sql = "INSERT INTO tempdoctor(tdId, tdKey) VALUES ('$username','$password')";
                                ...
                                if(mysqli_query($con,$sql)){
                                    ...
                                    >
                                        <strong>Doctor account crated </strong> give doc to doc info
                                    ...
                                    >
                                        <strong>Creation Faild </strong> Enter Valid Id and key
                                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                    </div>
                                    <?php
                                }
            ...
            ?>
				...
				<div class="card" style="width: 30rem; background-color: #E5E4E2;">
				
					<div class="card-body">
						<form method="POST" action="">
							<left>
								<div class="mb-3">
									<label for="Id" class="form-label">Set Doctor Id:</label>
									<input type="text" class="form-control"name="id" id="id" required>
									
								</div></left>
				
								<div class="mb-3">
									<label for="password" class="form-label">Set Doctor PIN</label>
									<input type="password" class="form-control" id="password"name="password" required>
									
								</div>
								
								<button type="submit" class="btn btn-primary" name="submit">Set Up</button>
						</form>
					</div>
				</div>
