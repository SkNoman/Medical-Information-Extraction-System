...
<body>
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item">
						<a class="nav-link" href="signup_patient.php">Sign Up</a>
					</li>
  ...
  <center><img src="images/login.png" alt="logo" width="200" height="200"></center>

  <center>	<div class="col-sm">
				<div class="card" style="width: 30rem; background-color:#11C8EF;">
				
					<div class="card-body">
						<form method="POST" action="login_connection.php" id="signup">
							<left>
						...
						<?php
  							...
  							$_SESSION['tb']= "patientdata";
            				$_SESSION['location']="location:patientHome.php";
            				$_SESSION['id']="pId";
            				$_SESSION['pass']="pPassword";
							$_SESSION['else']= "location:login_patient.php";
  				 		?>
