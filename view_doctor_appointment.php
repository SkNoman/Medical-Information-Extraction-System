...
<body>
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
						<a class="nav-link active" href="#">Todays Appointments</a>
					</li>
					<li class="nav-item">
						<a class="nav-link active" href="view_all_apoinment.php">My all Appointments</a>
					</li>
                    <li class="nav-item">
	...
	<?php 
		...
		$sql = "SELECT * FROM `appoinment` WHERE dId='$sid' AND aDate='$date'";
		...
		if($row==0){
			...
			<div class="alert alert-warning alert-dismissible fade show" role="alert"
            	...
            	>
                <strong>No appoinment Today </strong>
