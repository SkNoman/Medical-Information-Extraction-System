	...
	<div class="row">
		<div class="col-sm">
			<div class="card" style="width: 30rem;">
				<img src="images/staff-4.jpg" class="card-img-top" alt="online doctor">
				<div class="card-body">
					<a href="#" class="btn btn-info">Dr Berh Harmon</a>
					<a href="#" class="btn btn-success">Contact with her</a><br><br>
					<h5 class="card-title">Update</h5>
					<p class="card-text">Please Update with the correct information.<br>As they work for mankind
					.</p>
		...
		<div class="col-sm">
			<div class="alert alert-warning alert-dismissible fade show" role="alert">
				<strong>Search for doctor first by Id!</strong>. Then Update his/her info.
				<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
			</div>
